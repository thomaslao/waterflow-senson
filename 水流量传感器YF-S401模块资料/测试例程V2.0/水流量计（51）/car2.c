...
sbit left_motor1=P2^0;				       //P1_0设置为电机控制一
sbit left_motor2=P2^1;				       //P1_1设置为电机控制二
sbit right_motor1=P2^2;				       //P1_0设置为电机控制一
sbit right_motor2=P2^3;				       //P1_1设置为电机控制二

sbit blackline_detection =P3^2;					       //P3_2设置为黑带检测位
...
bit direction;/***方向标志***/
static uchar j;
static uchar constant=0;//可以改变占空比
...
{
	Speed=SpeedCount*CircleLength/4;					//计算瞬时速度
	Distance+=Speed;								//计算距离						
	SpeedCount=0;
}
